...
into_en = ['de-en', 'es-en', 'it-en', 'zh-en']
into_it = ['de-it', 'es-it', 'en-it',  'zh-it']
into_zh = ['de-zh', 'es-zh', 'en-zh',  'it-zh']
...
subsets = {'all': lps, 'into_en': into_en, 'from_en': from_en, 'into_de': into_de, 'from_de': from_de,'into_it': into_it, 
        'from_it': from_it, 'into_zh': into_zh, 'from_zh': from_zh, 'from_es': from_es}
